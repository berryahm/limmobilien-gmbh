...
export default async function Valuation({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <section className="max-w-[1400px] mx-auto px-8 lg:px-12 pt-28 pb-32">
      ...
      <h1 className="serif text-5xl md:text-7xl mb-8 max-w-4xl" style={{ color: "#3a170b" }}>{dict.valuation.title}</h1>
      <p className="max-w-2xl leading-relaxed text-lg mb-16" style={{ color: "#8a7363" }}>{dict.valuation.intro}</p>
