  ...
  return (
    <>
      ...
      <section className="max-w-[1400px] mx-auto px-8 lg:px-12 pt-28 pb-16">
        ...
        <h1 className="serif text-5xl md:text-7xl max-w-3xl" style={{ color: "#2a1610" }}>{dict.buy.title}</h1>
        <p className="mt-8 max-w-2xl leading-relaxed text-lg" style={{ color: "#8a7363" }}>{dict.buy.intro}</p>
      </section>
