  ...
  return (
    <>
      ...
      <section className="max-w-[1400px] mx-auto px-6 lg:px-12 pt-28 pb-16">
        ...
        <h1 className="serif text-5xl md:text-7xl max-w-3xl" style={{ color: "#1e100a" }}>{dict.buy.title}</h1>
        <p className="mt-8 max-w-2xl leading-relaxed text-lg" style={{ color: "#8a7a6a" }}>{dict.buy.intro}</p>
      </section>
